...
getNewQuestion = () => {
  if (availableQuestions.length === 0 || questionCounter >= MAX_QUESTIONS) {
    ...
    return window.location.replace("https://craindavis.github.io/FunTrivia/submit-scores.html");
  }
...
setTime = () => {
  let timerInterval = setInterval(function () {
    ...
    if (timeLeft === 0) {
      ...
      return window.location.replace("https://craindavis.github.io/FunTrivia/game-over.html");
    }
  }, 1000);
};
